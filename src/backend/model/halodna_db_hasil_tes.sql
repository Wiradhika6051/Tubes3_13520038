...
--
-- Host: localhost    Database: halodna_db
-- ------------------------------------------------------
...
CREATE TABLE `hasil_tes` (
  ...
  `kemiripan` decimal(4,2) DEFAULT NULL,
  PRIMARY KEY (`id_tes`)
...
INSERT INTO `hasil_tes` VALUES (1,'ucok','halu','True','2022-04-13',0.00);
...
-- Dump completed on 2022-04-23 13:16:41
